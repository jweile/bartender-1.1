...
BARTENDEREXTRACTORSOURCES	= ./src/kmerdecoder.cpp ./src/kmers_bitwisetransform.cpp ./src/kmers_dictionary.cpp ./src/sequence.cpp ./src/util.cpp ./src/singlereadsprocessor.cpp ./src/bartender_extractor.cpp ./src/barcodeextractor.cpp ./src/pattern.cpp ./src/fastapattern.cpp ./src/fastqpattern.cpp ./src/UmiExtractor.cpp ./src/SingleReadProcessorWithUmi.cpp
...
$(EXTRACTOR): $(BARTENDEREXTRACTOROBJECTS) 
	$(CC) $(BARTENDEREXTRACTOROBJECTS) -o $@
